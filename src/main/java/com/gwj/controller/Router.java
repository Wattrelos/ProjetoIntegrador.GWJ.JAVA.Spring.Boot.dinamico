...
public class Router {
    ...
    public String checkout(
        ...
        try {
            ...
            if (profissionalId != null && profissionalId > 0) {
                IService<com.gwj.model.domain.entities.Profissional> profService = ServiceRegistry
                        .getService("Profissional");
            ...
            if (session != null) {
                com.gwj.model.domain.entities.Usuario usuarioLogado = (com.gwj.model.domain.entities.Usuario) session
                        .getAttribute("usuarioLogado");
                if (usuarioLogado != null) {
                    IService<com.gwj.model.domain.entities.Cliente> clienteService = ServiceRegistry
                            .getService("Cliente");
    ...
    public String orderConfirmation(@RequestParam("id") Long agendamentoId, Model model) {
        try {
            IService<com.gwj.model.domain.entities.Agendamento> agendamentoService = ServiceRegistry
                    .getService("Agendamento");
            ...
            if (!resultados.isEmpty()) {
                ...
                if (agendamento.getDataAgendamento() != null && agendamento.getHoraInicio() != null) {
                    java.time.LocalDateTime dt = java.time.LocalDateTime.of(agendamento.getDataAgendamento(),
